    ...
    SubShader
    {
        ...
        Pass 
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half NdotL = saturate(dot(normalWS, lightDir)); // DIFFUSE
                half NdotH = saturate(dot(normalWS, halfDir)); // SPECULAR
                ...
                // Final COLOR
                half3 finalColor = texColor * (diffuse + specularColor);
