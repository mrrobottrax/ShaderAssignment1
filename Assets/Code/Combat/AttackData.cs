...
public class AttackData_Editor : Editor
{
    ...
    SerializedProperty impactSounds;
    ...
    void OnEnable()
    {
        ...
        impactSounds = serializedObject.FindProperty("<ImpactSounds>k__BackingField");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (isPhysicalAttack.boolValue)
        {
            ...
            EditorGUILayout.PropertyField(impactSounds);
        }
