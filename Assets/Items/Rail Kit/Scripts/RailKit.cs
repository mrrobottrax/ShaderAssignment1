...
public class RailKit : UseableItem
{
	...
	protected override void PickUpInteraction(PlayerInteraction interactor)
	{
		...
		if (inventory.GetActiveSlot().items.Count != 0)
		{
			...
			if (inventory.FindItemWhere(IsNotFull) != null)
			{
				...
				{
					Debug.Log("TODO: Request absorb metres");
				}
				return;
			}
		}
		...
		// Normal pickup
		CreatePreview();
		base.PickUpInteraction(interactor);
	}
	...
	public override void OnEquipFirstPerson()
	{
		base.OnEquipFirstPerson();
		CreatePreview();
	}

	public override void OnUnEquipFirstPerson()
	{
		base.OnUnEquipFirstPerson();
